	...
	<body>
		...
		<div id="show-telefono" class="content scaffold-show" role="main">
			...
			<ol class="property-list telefono">
				...
				<g:if test="${telefonoInstance?.area}">
				<li class="fieldcontain">
					<span id="area-label" class="property-label"><g:message code="telefono.area.label" default="Area" /></span>
					
						<span class="property-value" aria-labelledby="area-label"><g:fieldValue bean="${telefonoInstance}" field="area"/></span>
